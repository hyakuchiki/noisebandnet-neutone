...
from noisebandnet.ddsp.features import FeatureProcessor
from noisebandnet.ddsp.util import find_audio_files, load_audio_file
...
class SmallDataset(Dataset):
    ...
    def __init__(
        ...
        if os.path.isdir(raw_path):
            ...
            raise ValueError(f"raw_path {raw_path} is not a valid file or directory.")
